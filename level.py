...
class Level : 
    ...
    def __init__ (self, i_jeu, i_level) :
        ...
        self.lvl_padding_px = i_jeu.hauteur_fenetre() * self.lvl_padding_pct / 100
        self.lvl_vertical_stt_px = i_jeu.hauteur_fenetre() * self.lvl_vertical_stt_pct / 100
        self.lvl_vertical_end_px = i_jeu.hauteur_fenetre() * self.lvl_vertical_end_pct / 100
