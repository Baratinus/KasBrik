...
class Balle:
    ...
    def deplacer(self): #Bouger la balle dans le canevas pour la raquette
        #-----------------------------Raquette-----------------------------#
        if self.jeu.raquette.collision(self.x+self.rayon) == 1: #Si la collision revoie 1
            self.vitesse_x = -1
            self.vitesse_y = -2
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        elif self.jeu.raquette.collision(self.x+self.rayon) == 2: #Si la collision revoie 2
            self.vitesse_x = -2
            self.vitesse_y = -1
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        elif self.jeu.raquette.collision(self.x+self.rayon) == 3: #Si la collision revoie 3
            self.vitesse_x = -2
            self.vitesse_y = 0
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        elif self.jeu.raquette.collision(self.x+self.rayon) == 4: #Si la collision revoie 4
            self.vitesse_x = -2
            self.vitesse_y = 1
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        elif self.jeu.raquette.collision(self.x+self.rayon) == 5: #Si la collision revoie 5
            self.vitesse_x = -1
            self.vitesse_y = 2
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        #-----------------------------Bords de la fenêtre-----------------------------#
            ...
            self.jeu.canevas.move(self.jeu.balle,self.vitesse_x,self.vitesse_y)
        elif self.jeu.largeur_fenetre == self.x + self.rayon*2 or self.x == 0 : #Si la balle touche la gauche ou la droite, ça inverse la vitesse en abscisse
